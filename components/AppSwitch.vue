<template>
  <div class="sidearea">
    <h4>Farm direct</h4>
    <div class="can-toggle tinyfood">
      <input id="e" type="checkbox" v-model="trigger" @change="updateFarmdirect">
      <label for="e">
...
export default {
  ...
  computed: {
    checked() {
      return this.$store.state.farmdirect;
    }
  },
  methods: {
    updateFarmdirect() {
      this.$store.commit('switchFarmdirect');
    }
  }
};
</script>

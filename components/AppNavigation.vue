<template>
  <div class="navarea">
    <nav>
      <div class="capsule">
              <div class="capsule"><A href= "/" title="Tiny Food"><img src="/logo.svg" class="popov" height=55 border=0></A></div>
              <div class="capsule" style="width:30px;"></div>

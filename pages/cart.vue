<template>
  <div class="capsule cart">
    ...
    <div v-else-if="cartTotal === 0 && success === false" class="empty">
      ...
      <nuxt-link exact to="/"><button>Add a product!</button></nuxt-link>
      you may wish to <nuxt-link exact to="/start-a-hub"><button>start your own food hub!</button></nuxt-link>
    </div>
